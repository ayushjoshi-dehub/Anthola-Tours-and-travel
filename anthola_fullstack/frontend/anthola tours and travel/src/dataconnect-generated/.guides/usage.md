...
```ts
import { useCreateUser, useGetProfile, useCreateCategory, useCreateContentItem } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useCreateContentItem(createContentItemVars);
