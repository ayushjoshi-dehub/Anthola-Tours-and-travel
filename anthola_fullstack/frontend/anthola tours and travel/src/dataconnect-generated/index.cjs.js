...
const createContentItemRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'CreateContentItem', inputVars);
}
createContentItemRef.operationName = 'CreateContentItem';
exports.createContentItemRef = createContentItemRef;

exports.createContentItem = function createContentItem(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(createContentItemRef(dcInstance, inputVars));
}
;
