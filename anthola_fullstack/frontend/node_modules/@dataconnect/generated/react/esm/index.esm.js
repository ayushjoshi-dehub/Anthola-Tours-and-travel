import { createUserRef, getProfileRef, createCategoryRef, createContentItemRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useCreateContentItem(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
